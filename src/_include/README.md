...
[SiRun.h] and [SiRun.cpp] provide an easy to use mechanism to
develop C++ modules (plugins) callable on user request. 
They define the following classes and namespaces:
...
[SiRun.h] implements how the modules are run, and [SiRun.cpp] implements
...
SiR class and adding more modules as function pointers.
